@extends('app')
@section('title','La comunidad mas grande de adopcion')
		...
		<div class="camera_caption">
			<div class="main-container">
				<div class="container">
					...
					<h1 class="wow fadeInUp animated">Entrena <br>a tu mascota.</h1>
					...
					<div class="center">
						...
						<a href="course-2-column.html" class="tran3s wow fadeInRight animated button-two" data-wow-delay="0.499s"><img src="{{ asset('images/icon/2.png')}}" alt="">GooglePlay</a>			
					</div>
				</div>
			</div> 
		</div> 
